...
public class OPPLPatternsTypes extends TreeFilter {
    ...
    public String[] getTokenNames() {
        return OPPLPatternsTypes.tokenNames;
    }

    @Override
    public String getGrammarFileName() {
        return "/Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g";
    }
    ...
    public final void bottomup() {
        try {
            ...
            // ( pattern )
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:97:6:
            // pattern
            {
    ...
    public final OPPLPatternsTypes.pattern_return pattern() {
        ...
        try {
            ...
            // (rc= returnClause )? ) )
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:103:3:
            // ^( OPPL_PATTERN ^(s= OPPL_STATEMENT ( . )* ) (ren= rendering )?
            // (rc= returnClause )? )
            {
                match(input, OPPL_PATTERN, FOLLOW_OPPL_PATTERN_in_pattern99);
                if (state.failed) {
                    return retval;
                }
                ...
                s = (OPPLSyntaxTree) match(input, OPPL_STATEMENT,
                        FOLLOW_OPPL_STATEMENT_in_pattern106);
                if (state.failed) {
                    return retval;
                }
                ...
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:103:47:
                // (ren= rendering )?
                int alt2 = 2;
                ...
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:103:63:
                // (rc= returnClause )?
                int alt3 = 2;
                    ...
                    if (s.getOPPLContent() instanceof OPPLScript) {
                        try {
                            ...
                            getErrorListener().illegalToken(
                                    s,
                                    "Unsuitable OPPL statement for a pattern "
                                            + e.getMessage());
                        }
                    }
                }
    ...
    public final String rendering() {
        ...
        try {
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:124:3:
            // ( ^( RENDERING ( renderingPart )+ ) )
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:125:5:
            // ^( RENDERING ( renderingPart )+ )
            {
                RENDERING1 = (OPPLSyntaxTree) match(input, RENDERING,
                        FOLLOW_RENDERING_in_rendering153);
                if (state.failed) {
                    return string;
                }
                match(input, Token.DOWN, null);
                ...
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:125:17:
                // ( renderingPart )+
                int cnt4 = 0;
                loop4: do {
                    int alt4 = 2;
    ...
    public final void renderingPart() {
        ...
        try {
            ...
            // ( IDENTIFIER | VARIABLE_NAME | THIS_CLASS | HYPHEN )
            int alt5 = 4;
            switch (input.LA(1)) {
                case IDENTIFIER: {
                    alt5 = 1;
            ...
            switch (alt5) {
                ...
                // THIS_CLASS
                {
                    ...
                    break;
                case 4:
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:144:7:
                // HYPHEN
                {
                    match(input, REGEXP_CONSTRAINT,
                            FOLLOW_REGEXP_CONSTRAINT_in_renderingPart214);
                    if (state.failed) {
                        return;
                    }
                }
    ...
    public final Variable<?> returnClause() {
        ...
        try {
            ...
            // ( ^( RETURN VARIABLE_NAME ) | ^( RETURN THIS_CLASS ) )
            int alt6 = 2;
            ...
            switch (alt6) {
                case 1:
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:149:7:
                // ^( RETURN VARIABLE_NAME )
                {
                    match(input, RETURN, FOLLOW_RETURN_in_returnClause242);
                    if (state.failed) {
                        return variable;
                    }
                    match(input, Token.DOWN, null);
                    ...
                    if (state.backtracking == 1) {
                        variable = getConstraintSystem().getVariable(
                                VARIABLE_NAME3.getText());
                        if (variable == null) {
                            if (getErrorListener() != null) {
                                getErrorListener().illegalToken(VARIABLE_NAME3,
                                        "Undefined variable");
                            }
                        }
                    }
                    ...
                    break;
                case 2:
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsTypes.g:158:7:
                // ^( RETURN THIS_CLASS )
                {
                    match(input, RETURN, FOLLOW_RETURN_in_returnClause262);
                    if (state.failed) {
                        return variable;
                    }
                    match(input, Token.DOWN, null);
    ...
    // Delegated rules
    public static final BitSet FOLLOW_pattern_in_bottomup81 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_OPPL_PATTERN_in_pattern99 = new BitSet(
    ...
    public static final BitSet FOLLOW_IDENTIFIER_in_renderingPart182 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_VARIABLE_NAME_in_renderingPart190 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_THIS_CLASS_in_renderingPart206 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_REGEXP_CONSTRAINT_in_renderingPart214 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_RETURN_in_returnClause242 = new BitSet(
            new long[] { 0x0000000000000004L });
    public static final BitSet FOLLOW_VARIABLE_NAME_in_returnClause244 = new BitSet(
            new long[] { 0x0000000000000008L });
    public static final BitSet FOLLOW_RETURN_in_returnClause262 = new BitSet(
            new long[] { 0x0000000000000004L });
    public static final BitSet FOLLOW_THIS_CLASS_in_returnClause264 = new BitSet(
            new long[] { 0x0000000000000008L });
}
