// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsReferenceDefine.g 2011-01-10 16:38:16
...
public class OPPLPatternsReferenceDefine extends TreeRewriter {
    ...
    // ) -> ^( $pr) ;
    public final OPPLPatternsReferenceDefine.patternReference_return
            patternReference() {
        ...
        try {
            ...
            // ^(pr= IDENTIFIER PATTERN_REFERENCE (args= arguments )? )
            {
                _last = (OPPLSyntaxTree) input.LT(1);
                {
                    ...
                    _last = (OPPLSyntaxTree) input.LT(1);
                    PATTERN_REFERENCE2 = (OPPLSyntaxTree) match(input,
                            PATTERN_REFERENCE,
                ...
                if (state.backtracking == 1) {
                    if (args == null) {
                        getPatternReferenceResolver().resolvePattern(pr,
                                PATTERN_REFERENCE2.getText(),
                                getConstraintSystem(), getSymbolTable());
                    } else {
                        getPatternReferenceResolver().resolvePattern(pr,
                                PATTERN_REFERENCE2.getText(),
                                getConstraintSystem(), getSymbolTable(),
                ...
                if (state.backtracking == 1) {
                    retval.tree = root_0;
                    RewriteRuleNodeStream stream_pr = new RewriteRuleNodeStream(
                            adaptor, "token pr", pr);
    ...
    public final OPPLPatternsReferenceDefine.argument_return argument() {
        ...
        try {
            ...
            switch (alt4) {
                case 1:
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsReferenceDefine.g:131:2:
                // ^( ARGUMENT ^( EXPRESSION ^( IDENTIFIER VARIABLE_NAME DOT
                // VALUES ) ) )
                {
                    _last = (OPPLSyntaxTree) input.LT(1);
                    ...
                    break;
                case 2:
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsReferenceDefine.g:135:4:
                // ^( ARGUMENT (a= . )+ )
                {
                    _last = (OPPLSyntaxTree) input.LT(1);
                    {
                        ...
                        // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsReferenceDefine.g:135:15:
                        // (a= . )+
                        int cnt3 = 0;
                        loop3: do {
                            int alt3 = 2;
                            ...
                            switch (alt3) {
                                case 1:
                                // /Users/luigi/Documents/workspace/Parsers/src/OPPLPatternsReferenceDefine.g:135:16:
                                // a= .
                                {
                                    _last = (OPPLSyntaxTree) input.LT(1);
    ...
    public static final BitSet FOLLOW_ARGUMENTS_in_arguments147 = new BitSet(
            new long[] { 0x0000000000000004L });
    public static final BitSet FOLLOW_argument_in_arguments152 = new BitSet(
            new long[] { 0x0000000000000008L, 0x0002000000000000L });
    ...
    public static final BitSet FOLLOW_DOT_in_argument193 = new BitSet(
