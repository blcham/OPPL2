...
public class PatternReferenceGeneratedVariable<O extends OWLObject> extends
     ...
     *        value
     */
    public PatternReferenceGeneratedVariable(String referenceName,
            VariableType<O> type, PatternReference value) {
    ...
    public static <T extends OWLObject> PatternReferenceGeneratedVariable<T>
        ...
        return new PatternReferenceGeneratedVariable<>(referenceName, type,
                value);
    }
}
